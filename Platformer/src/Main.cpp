...
int main()
{
    ...
    double xVel = 0.35;
    double yVel = 0.64; // jump ~200 pixels
    ...
    m->addShape(new Rectangle(500, 100, 0, 100, 250, 0, 0, 127));
    m->addShape(new Rectangle(650, 250, 0, 100, 100, 0, 0, 127));
    m->addShape(new Rectangle(600, 400, 0, 100, 100, 0, 0, 127));
    m->addShape(new Rectangle(600, 450, 0, 100, 100, 0, 0, 127));
    GLFWwindow* window;
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		*/
        ...
        //std::cout << p->getXVelocity() << " : " << p->getYVelocity() << '\n';
